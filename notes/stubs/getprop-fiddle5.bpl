...
procedure #CacheStub~GetProp(emitPath: EmitPath)
{
  ...
  var $tmp'v3: #ValueId;
  var $tmp'v4: #ShapeField;
  var $tmp'v5: #Shape;
  var $tmp'v6: #Shape;
  var $tmp'v7: #ShapeField;
  var $tmp'v8: #Shape;
  var $tmp'v9: #Shape;
  var $tmp'v10: #Shape;
  var $tmp'v11: #BaseShape;
  var $tmp'v12: #BaseShape;
  var $tmp'v13: #Shape;
  var $tmp'v14: #Class;
  var $tmp'v15: #Class;
  var $tmp'v16: #Shape;
  ...
  var $tmp'v19: #UInt32;
  var $tmp'v20: #Shape;
  var $tmp'v21: #BaseShape;
  var $tmp'v22: #BaseShape;
  var $tmp'v23: #Shape;
  var $tmp'v24: #Class;
  var $tmp'v25: #Class;
  var $tmp'v26: #Shape;
  ...
  var $tmp'v28: #Shape;
  var $tmp'v29: #UInt32;
  var $tmp'v30: #BaseShape;
  var $tmp'v31: #TaggedProto;
  var $tmp'v32: #TaggedProto;
  var $tmp'v33: #BaseShape;
  var $tmp'v34: #TaggedProto;
  var $tmp'v35: #TaggedProto;
  var $tmp'v36: #Class;
  var $tmp'v37: #Class;
  var $tmp'v38: #TaggedProto;
  var $tmp'v39: #TaggedProto;
  var $tmp'v40: #ValueId;
  var $tmp'v41: #ObjectId;
  var $tmp'v42: #ObjectField;
  var $tmp'v43: #ObjectId;
  var $tmp'v44: #ShapeField;
  var $tmp'v45: #ObjectId;
  var $tmp'v46: #ObjectId;
  var $tmp'v47: #ObjectId;
  var $tmp'v48: #ShapeField;
  var $tmp'v49: #ObjectId;
  var $tmp'v50: #ObjectId;
  var $tmp'v51: #ObjectId;
  var $tmp'v52: #ShapeField;
  var $tmp'v53: #ObjectId;
  var $tmp'v54: #ObjectId;
  var $tmp'v55: #ObjectId;
  var $tmp'v56: #ShapeField;
  var $tmp'v57: #ObjectId;
  var $tmp'v58: #ObjectId;
  var $tmp'v59: #ObjectId;
  var $tmp'v60: #ShapeField;
  var $tmp'v61: #ObjectId;
  var $tmp'v62: #ObjectId;
  var $tmp'v63: #ObjectId;
  var $tmp'v64: #ShapeField;
  var out'0: #OperandId;
  var out'1: #OperandId;
  var out'2: #OperandId;
  var out'3: #ValueId;
  var out'4: #Class;
  var out'5: #Class;
  var out'6: #TaggedProto;
  var out'7: #TaggedProto;
  var out'8: #Bool;
  var out'9: #Bool;
  var out'10: #ValueId;
  var out'11: #ObjectId;
  ...
  call out'3 := #ValueId~fromId(0bv16);
  $tmp'v3 := out'3;
  call #initInputValueId($tmp'v3);
  $tmp'v4 := #ShapeField~fromOffset(8bv32);
  $tmp'v5 := #CacheIR~readShapeField($tmp'v4);
  $tmp'v6 := #Shape~fromAddr(22494905973888bv64);
  assume ($tmp'v5 == $tmp'v6);
  $tmp'v7 := #ShapeField~fromOffset(16bv32);
  $tmp'v8 := #CacheIR~readShapeField($tmp'v7);
  $tmp'v9 := #Shape~fromAddr(27386543016448bv64);
  assume ($tmp'v8 == $tmp'v9);
  $tmp'v10 := #Shape~fromAddr(22494905973888bv64);
  $tmp'v11 := #Shape~baseShapeOf($tmp'v10);
  $tmp'v12 := #BaseShape~fromAddr(27386542560232bv64);
  assume ($tmp'v11 == $tmp'v12);
  $tmp'v13 := #Shape~fromAddr(22494905973888bv64);
  call out'4 := #Shape~classOf($tmp'v13);
  $tmp'v14 := out'4;
  $tmp'v15 := #Class~fromAddr(139810476801384bv64);
  assume ($tmp'v14 == $tmp'v15);
  $tmp'v16 := #Shape~fromAddr(22494905973888bv64);
  $tmp'v17 := #Shape~numFixedSlots($tmp'v16);
  assume ($tmp'v17 == 2bv32);
  $tmp'v18 := #Shape~fromAddr(22494905973888bv64);
  $tmp'v19 := #Shape~slotSpan($tmp'v18);
  assume ($tmp'v19 == 4bv32);
  $tmp'v20 := #Shape~fromAddr(27386543016448bv64);
  $tmp'v21 := #Shape~baseShapeOf($tmp'v20);
  $tmp'v22 := #BaseShape~fromAddr(792570921816bv64);
  assume ($tmp'v21 == $tmp'v22);
  $tmp'v23 := #Shape~fromAddr(27386543016448bv64);
  call out'5 := #Shape~classOf($tmp'v23);
  $tmp'v24 := out'5;
  $tmp'v25 := #Class~fromAddr(139810476811216bv64);
  assume ($tmp'v24 == $tmp'v25);
  $tmp'v26 := #Shape~fromAddr(27386543016448bv64);
  $tmp'v27 := #Shape~numFixedSlots($tmp'v26);
  assume ($tmp'v27 == 0bv32);
  $tmp'v28 := #Shape~fromAddr(27386543016448bv64);
  $tmp'v29 := #Shape~slotSpan($tmp'v28);
  assume ($tmp'v29 == 12bv32);
  $tmp'v30 := #BaseShape~fromAddr(27386542560232bv64);
  call out'6 := #BaseShape~protoOf($tmp'v30);
  $tmp'v31 := out'6;
  $tmp'v32 := #TaggedProto~fromAddr(792570930632bv64);
  assume ($tmp'v31 == $tmp'v32);
  $tmp'v33 := #BaseShape~fromAddr(792570921816bv64);
  call out'7 := #BaseShape~protoOf($tmp'v33);
  $tmp'v34 := out'7;
  $tmp'v35 := #TaggedProto~fromAddr(0bv64);
  assume ($tmp'v34 == $tmp'v35);
  $tmp'v36 := #Class~fromAddr(139810476811216bv64);
  assume #Class~isNativeObject($tmp'v36);
  $tmp'v37 := #Class~fromAddr(139810476801384bv64);
  assume #Class~isNativeObject($tmp'v37);
  $tmp'v38 := #TaggedProto~fromAddr(792570930632bv64);
  call out'8 := #TaggedProto~isObject($tmp'v38);
  assume out'8;
  $tmp'v39 := #TaggedProto~fromAddr(0bv64);
  call out'9 := #TaggedProto~isNull($tmp'v39);
  assume out'9;
  call out'10 := #ValueId~fromId(0bv16);
  $tmp'v40 := out'10;
  call #CacheIR~GuardNonDoubleType($tmp'v40, #ValueType^Variant~Bool(), ConsEmitPath(emitPath, 0));
  call out'11 := #ObjectId~fromId(1bv16);
  $tmp'v41 := out'11;
  $tmp'v42 := #ObjectField~fromOffset(0bv32);
  call #CacheIR~LoadObject($tmp'v41, $tmp'v42, ConsEmitPath(emitPath, 1));
  call out'12 := #ObjectId~fromId(1bv16);
  $tmp'v43 := out'12;
  $tmp'v44 := #ShapeField~fromOffset(8bv32);
  call #CacheIR~GuardShape($tmp'v43, $tmp'v44, ConsEmitPath(emitPath, 2));
  call out'13 := #ObjectId~fromId(1bv16);
  $tmp'v45 := out'13;
  call out'14 := #ObjectId~fromId(2bv16);
  $tmp'v46 := out'14;
  call #CacheIR~LoadProto($tmp'v45, $tmp'v46, ConsEmitPath(emitPath, 3));
  call out'15 := #ObjectId~fromId(2bv16);
  $tmp'v47 := out'15;
  $tmp'v48 := #ShapeField~fromOffset(16bv32);
  call #CacheIR~GuardShape($tmp'v47, $tmp'v48, ConsEmitPath(emitPath, 4));
  call out'16 := #ObjectId~fromId(1bv16);
  $tmp'v49 := out'16;
  call out'17 := #ObjectId~fromId(2bv16);
  $tmp'v50 := out'17;
  call #CacheIR~LoadProto($tmp'v49, $tmp'v50, ConsEmitPath(emitPath, 5));
  call out'18 := #ObjectId~fromId(2bv16);
  $tmp'v51 := out'18;
  $tmp'v52 := #ShapeField~fromOffset(16bv32);
  call #CacheIR~GuardShape($tmp'v51, $tmp'v52, ConsEmitPath(emitPath, 6));
  call out'19 := #ObjectId~fromId(1bv16);
  $tmp'v53 := out'19;
  call out'20 := #ObjectId~fromId(2bv16);
  $tmp'v54 := out'20;
  call #CacheIR~LoadProto($tmp'v53, $tmp'v54, ConsEmitPath(emitPath, 7));
  call out'21 := #ObjectId~fromId(2bv16);
  $tmp'v55 := out'21;
  $tmp'v56 := #ShapeField~fromOffset(16bv32);
  call #CacheIR~GuardShape($tmp'v55, $tmp'v56, ConsEmitPath(emitPath, 8));
  call out'22 := #ObjectId~fromId(1bv16);
  $tmp'v57 := out'22;
  call out'23 := #ObjectId~fromId(2bv16);
  $tmp'v58 := out'23;
  call #CacheIR~LoadProto($tmp'v57, $tmp'v58, ConsEmitPath(emitPath, 9));
  call out'24 := #ObjectId~fromId(2bv16);
  $tmp'v59 := out'24;
  $tmp'v60 := #ShapeField~fromOffset(16bv32);
  call #CacheIR~GuardShape($tmp'v59, $tmp'v60, ConsEmitPath(emitPath, 10));
  call out'25 := #ObjectId~fromId(1bv16);
  $tmp'v61 := out'25;
  call out'26 := #ObjectId~fromId(2bv16);
  $tmp'v62 := out'26;
  call #CacheIR~LoadProto($tmp'v61, $tmp'v62, ConsEmitPath(emitPath, 11));
  call out'27 := #ObjectId~fromId(2bv16);
  $tmp'v63 := out'27;
  $tmp'v64 := #ShapeField~fromOffset(16bv32);
  call #CacheIR~GuardShape($tmp'v63, $tmp'v64, ConsEmitPath(emitPath, 12));
  call #CacheIR~LoadUndefinedResult(ConsEmitPath(emitPath, 13));
  call #CacheIR~ReturnFromIC(ConsEmitPath(emitPath, 14));
  return;
}
...
procedure {:entrypoint} EntryPoint#CacheStub~GetProp()
{
  ...
  goto emit'0#CacheIR~GuardNonDoubleType'0#CacheIR~useValueId'0#MASM~TagValue, emit'0#CacheIR~GuardNonDoubleType'1#MASM~BranchTestString, emit'0#CacheIR~GuardNonDoubleType'2#MASM~BranchTestSymbol, emit'0#CacheIR~GuardNonDoubleType'3#MASM~BranchTestBigInt, emit'0#CacheIR~GuardNonDoubleType'4#MASM~BranchTestBoolean, emit'0#CacheIR~GuardNonDoubleType'5#MASM~BranchTestUndefined, emit'0#CacheIR~GuardNonDoubleType'6#MASM~BranchTestNull, emit'1#CacheIR~LoadObject'0#CacheIR~emitLoadObjectStubField'0#MASM~MovePtrImmGCPtrObject;
  
  emit'0#CacheIR~GuardNonDoubleType'0#CacheIR~useValueId'0#MASM~TagValue:
  ...
  goto emit'0#CacheIR~GuardNonDoubleType'1#MASM~BranchTestString, emit'0#CacheIR~GuardNonDoubleType'2#MASM~BranchTestSymbol, emit'0#CacheIR~GuardNonDoubleType'3#MASM~BranchTestBigInt, emit'0#CacheIR~GuardNonDoubleType'4#MASM~BranchTestBoolean, emit'0#CacheIR~GuardNonDoubleType'5#MASM~BranchTestUndefined, emit'0#CacheIR~GuardNonDoubleType'6#MASM~BranchTestNull, emit'1#CacheIR~LoadObject'0#CacheIR~emitLoadObjectStubField'0#MASM~MovePtrImmGCPtrObject;
  
  emit'0#CacheIR~GuardNonDoubleType'1#MASM~BranchTestString:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 0), 1));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestString($condition##MASM^Op~BranchTestString(op), $valueReg##MASM^Op~BranchTestString(op), $branch##MASM^Op~BranchTestString(op));
  goto emit^Exit, emit'1#CacheIR~LoadObject'0#CacheIR~emitLoadObjectStubField'0#MASM~MovePtrImmGCPtrObject;
  
  emit'0#CacheIR~GuardNonDoubleType'2#MASM~BranchTestSymbol:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 0), 2));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestSymbol($condition##MASM^Op~BranchTestSymbol(op), $valueReg##MASM^Op~BranchTestSymbol(op), $branch##MASM^Op~BranchTestSymbol(op));
  goto emit^Exit, emit'1#CacheIR~LoadObject'0#CacheIR~emitLoadObjectStubField'0#MASM~MovePtrImmGCPtrObject;
  
  emit'0#CacheIR~GuardNonDoubleType'3#MASM~BranchTestBigInt:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 0), 3));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestBigInt($condition##MASM^Op~BranchTestBigInt(op), $valueReg##MASM^Op~BranchTestBigInt(op), $branch##MASM^Op~BranchTestBigInt(op));
  goto emit^Exit, emit'1#CacheIR~LoadObject'0#CacheIR~emitLoadObjectStubField'0#MASM~MovePtrImmGCPtrObject;
  
  emit'0#CacheIR~GuardNonDoubleType'4#MASM~BranchTestBoolean:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 0), 4));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestBoolean($condition##MASM^Op~BranchTestBoolean(op), $valueReg##MASM^Op~BranchTestBoolean(op), $branch##MASM^Op~BranchTestBoolean(op));
  goto emit^Exit, emit'1#CacheIR~LoadObject'0#CacheIR~emitLoadObjectStubField'0#MASM~MovePtrImmGCPtrObject;
  
  emit'0#CacheIR~GuardNonDoubleType'5#MASM~BranchTestUndefined:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 0), 5));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestUndefined($condition##MASM^Op~BranchTestUndefined(op), $valueReg##MASM^Op~BranchTestUndefined(op), $branch##MASM^Op~BranchTestUndefined(op));
  goto emit^Exit, emit'1#CacheIR~LoadObject'0#CacheIR~emitLoadObjectStubField'0#MASM~MovePtrImmGCPtrObject;
  
  emit'0#CacheIR~GuardNonDoubleType'6#MASM~BranchTestNull:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 0), 6));
  op := #MASM^ops(#MASM^emitPath);
  ...
  emit'1#CacheIR~LoadObject'0#CacheIR~emitLoadObjectStubField'0#MASM~MovePtrImmGCPtrObject:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 1), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~MovePtrImmGCPtrObject($object##MASM^Op~MovePtrImmGCPtrObject(op), $dstReg##MASM^Op~MovePtrImmGCPtrObject(op));
  goto emit'2#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'2#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'2#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'2#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  ...
  goto emit'2#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'2#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'2#CacheIR~GuardShape'1#MASM~BranchTestObjectShape:
  ...
  goto emit^Exit, emit'3#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'3#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'2#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations:
  ...
  emit'3#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 3), 0), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  goto emit'3#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'3#CacheIR~LoadProto'1#MASM~LoadObjectProto:
  ...
  goto emit'3#CacheIR~LoadProto'2#MASM~UnboxObjectProto;
  
  emit'3#CacheIR~LoadProto'2#MASM~UnboxObjectProto:
  ...
  goto emit'4#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'4#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'4#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'4#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 4), 0), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  goto emit'4#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'4#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'4#CacheIR~GuardShape'1#MASM~BranchTestObjectShape:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 4), 1));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestObjectShape($condition##MASM^Op~BranchTestObjectShape(op), $objectReg##MASM^Op~BranchTestObjectShape(op), $shape##MASM^Op~BranchTestObjectShape(op), $scratchReg##MASM^Op~BranchTestObjectShape(op), $spectreRegToZero##MASM^Op~BranchTestObjectShape(op), $branch##MASM^Op~BranchTestObjectShape(op));
  goto emit^Exit, emit'5#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'5#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'4#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 4), 2));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestObjectShapeNoSpectreMitigations($condition##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $objectReg##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $shape##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $branch##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op));
  goto emit^Exit, emit'5#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'5#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'5#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 5), 0), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  goto emit'5#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'5#CacheIR~LoadProto'1#MASM~LoadObjectProto:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 5), 1));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~LoadObjectProto($objectReg##MASM^Op~LoadObjectProto(op), $protoReg##MASM^Op~LoadObjectProto(op));
  goto emit'5#CacheIR~LoadProto'2#MASM~UnboxObjectProto;
  
  emit'5#CacheIR~LoadProto'2#MASM~UnboxObjectProto:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 5), 2));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxObjectProto($srcReg##MASM^Op~UnboxObjectProto(op), $destReg##MASM^Op~UnboxObjectProto(op));
  goto emit'6#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'6#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'6#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'6#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 6), 0), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  goto emit'6#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'6#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'6#CacheIR~GuardShape'1#MASM~BranchTestObjectShape:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 6), 1));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestObjectShape($condition##MASM^Op~BranchTestObjectShape(op), $objectReg##MASM^Op~BranchTestObjectShape(op), $shape##MASM^Op~BranchTestObjectShape(op), $scratchReg##MASM^Op~BranchTestObjectShape(op), $spectreRegToZero##MASM^Op~BranchTestObjectShape(op), $branch##MASM^Op~BranchTestObjectShape(op));
  goto emit^Exit, emit'7#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'7#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'6#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 6), 2));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestObjectShapeNoSpectreMitigations($condition##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $objectReg##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $shape##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $branch##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op));
  goto emit^Exit, emit'7#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'7#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'7#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 7), 0), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  goto emit'7#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'7#CacheIR~LoadProto'1#MASM~LoadObjectProto:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 7), 1));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~LoadObjectProto($objectReg##MASM^Op~LoadObjectProto(op), $protoReg##MASM^Op~LoadObjectProto(op));
  goto emit'7#CacheIR~LoadProto'2#MASM~UnboxObjectProto;
  
  emit'7#CacheIR~LoadProto'2#MASM~UnboxObjectProto:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 7), 2));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxObjectProto($srcReg##MASM^Op~UnboxObjectProto(op), $destReg##MASM^Op~UnboxObjectProto(op));
  goto emit'8#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'8#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'8#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'8#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 8), 0), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  goto emit'8#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'8#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'8#CacheIR~GuardShape'1#MASM~BranchTestObjectShape:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 8), 1));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestObjectShape($condition##MASM^Op~BranchTestObjectShape(op), $objectReg##MASM^Op~BranchTestObjectShape(op), $shape##MASM^Op~BranchTestObjectShape(op), $scratchReg##MASM^Op~BranchTestObjectShape(op), $spectreRegToZero##MASM^Op~BranchTestObjectShape(op), $branch##MASM^Op~BranchTestObjectShape(op));
  goto emit^Exit, emit'9#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'9#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'8#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 8), 2));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestObjectShapeNoSpectreMitigations($condition##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $objectReg##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $shape##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $branch##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op));
  goto emit^Exit, emit'9#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'9#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'9#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 9), 0), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  goto emit'9#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'9#CacheIR~LoadProto'1#MASM~LoadObjectProto:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 9), 1));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~LoadObjectProto($objectReg##MASM^Op~LoadObjectProto(op), $protoReg##MASM^Op~LoadObjectProto(op));
  goto emit'9#CacheIR~LoadProto'2#MASM~UnboxObjectProto;
  
  emit'9#CacheIR~LoadProto'2#MASM~UnboxObjectProto:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 9), 2));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxObjectProto($srcReg##MASM^Op~UnboxObjectProto(op), $destReg##MASM^Op~UnboxObjectProto(op));
  goto emit'10#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'10#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'10#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'10#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 10), 0), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  goto emit'10#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'10#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'10#CacheIR~GuardShape'1#MASM~BranchTestObjectShape:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 10), 1));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestObjectShape($condition##MASM^Op~BranchTestObjectShape(op), $objectReg##MASM^Op~BranchTestObjectShape(op), $shape##MASM^Op~BranchTestObjectShape(op), $scratchReg##MASM^Op~BranchTestObjectShape(op), $spectreRegToZero##MASM^Op~BranchTestObjectShape(op), $branch##MASM^Op~BranchTestObjectShape(op));
  goto emit^Exit, emit'11#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'11#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'10#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 10), 2));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestObjectShapeNoSpectreMitigations($condition##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $objectReg##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $shape##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $branch##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op));
  goto emit^Exit, emit'11#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'11#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'11#CacheIR~LoadProto'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 11), 0), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  goto emit'11#CacheIR~LoadProto'1#MASM~LoadObjectProto;
  
  emit'11#CacheIR~LoadProto'1#MASM~LoadObjectProto:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 11), 1));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~LoadObjectProto($objectReg##MASM^Op~LoadObjectProto(op), $protoReg##MASM^Op~LoadObjectProto(op));
  goto emit'11#CacheIR~LoadProto'2#MASM~UnboxObjectProto;
  
  emit'11#CacheIR~LoadProto'2#MASM~UnboxObjectProto:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 11), 2));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxObjectProto($srcReg##MASM^Op~UnboxObjectProto(op), $destReg##MASM^Op~UnboxObjectProto(op));
  goto emit'12#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble, emit'12#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'12#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'12#CacheIR~GuardShape'0#CacheIR~useObjectId'0#CacheIR~useTypedId'0#MASM~UnboxNonDouble:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 12), 0), 0), 0));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  goto emit'12#CacheIR~GuardShape'1#MASM~BranchTestObjectShape, emit'12#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations;
  
  emit'12#CacheIR~GuardShape'1#MASM~BranchTestObjectShape:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 12), 1));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestObjectShape($condition##MASM^Op~BranchTestObjectShape(op), $objectReg##MASM^Op~BranchTestObjectShape(op), $shape##MASM^Op~BranchTestObjectShape(op), $scratchReg##MASM^Op~BranchTestObjectShape(op), $spectreRegToZero##MASM^Op~BranchTestObjectShape(op), $branch##MASM^Op~BranchTestObjectShape(op));
  goto emit^Exit, emit'13#CacheIR~LoadUndefinedResult'0#MASM~MoveValueImm;
  
  emit'12#CacheIR~GuardShape'2#MASM~BranchTestObjectShapeNoSpectreMitigations:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 12), 2));
  op := #MASM^ops(#MASM^emitPath);
  call #MASM~BranchTestObjectShapeNoSpectreMitigations($condition##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $objectReg##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $shape##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op), $branch##MASM^Op~BranchTestObjectShapeNoSpectreMitigations(op));
  goto emit^Exit, emit'13#CacheIR~LoadUndefinedResult'0#MASM~MoveValueImm;
  
  emit'13#CacheIR~LoadUndefinedResult'0#MASM~MoveValueImm:
  assume {:partition} (#MASM^emitPath == ConsEmitPath(ConsEmitPath(NilEmitPath(), 13), 0));
  op := #MASM^ops(#MASM^emitPath);
