...
var #MASM^labelEmitPaths: [#MASM^Label]EmitPath;
...
{
  #MASM^labelEmitPaths[label] := #MASM^nextEmitPath(#MASM^emitPath);
}

procedure {:inline 1} #MASM^bindExit(label: #MASM^Label)
{
  #MASM^labelEmitPaths[label] := NilEmitPath();
}

procedure {:inline 1} #MASM^goto(label: #MASM^Label)
{
  #MASM^emitPath := #MASM^labelEmitPaths[label];
}
