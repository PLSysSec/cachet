...
function #MASM^ops(pc: Pc): #MASM^Op;
...
function #MASM^pcEmitPaths(pc: Pc): EmitPath;

procedure #MASM^emit(op: #MASM^Op, emitPath: EmitPath)
{
  assume (#MASM^pcEmitPaths(#MASM^pc) == emitPath);
  assume (#MASM^ops(#MASM^pc) == op);
  #MASM^pc := (#MASM^pc + 1);
}
...
function #MASM^labelPc(label: #MASM^Label): Pc;
...
function {:constructor} #MASM^Op~Jump($target: #MASM^Label): #MASM^Op;

procedure #MASM~Jump($target: #MASM^Label)
{
...
function {:constructor} #MASM^Op~FallibleUnboxObject($valueReg: #ValueReg, $objectReg: #Reg, $failure: #MASM^Label): #MASM^Op;

procedure #MASM~FallibleUnboxObject($valueReg: #ValueReg, $objectReg: #Reg, $failure: #MASM^Label)
{
  var $value'v0: #Value;
...
function {:constructor} #MASM^Op~FallibleUnboxBoolean($valueReg: #ValueReg, $boolReg: #Reg, $failure: #MASM^Label): #MASM^Op;

procedure #MASM~FallibleUnboxBoolean($valueReg: #ValueReg, $boolReg: #Reg, $failure: #MASM^Label)
{
  var $value'v0: #Value;
...
function {:constructor} #MASM^Op~BranchTestNumber($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestNumber($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label)
{
  var $value'v0: #Value;
...
function {:constructor} #MASM^Op~BranchTestDouble($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestDouble($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label)
{
  var $value'v0: #Value;
...
function {:constructor} #MASM^Op~BranchTestInt32($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestInt32($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label)
{
  var $value'v0: #Value;
...
function {:constructor} #MASM^Op~BranchTestInt32Truthy($truthy: #Bool, $valueReg: #ValueReg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestInt32Truthy($truthy: #Bool, $valueReg: #ValueReg, $branch: #MASM^Label)
{
  var $value'v0: #Value;
  var $int32'v1: #Int32;
  var $tmp'v2: #Bool;
...
function {:constructor} #MASM^Op~BranchTestBoolean($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestBoolean($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label)
{
  var $value'v0: #Value;
  var $valueIsBool'v1: #Bool;
  var $tmp'v2: #Bool;
...
function {:constructor} #MASM^Op~BranchTestString($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestString($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label)
{
  var $value'v0: #Value;
...
function {:constructor} #MASM^Op~BranchTestSymbol($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestSymbol($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label)
{
  var $value'v0: #Value;
...
function {:constructor} #MASM^Op~BranchTestBigInt($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestBigInt($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label)
{
  var $value'v0: #Value;
...
function {:constructor} #MASM^Op~BranchTestValue($cond: #Condition, $lhs: #BaseIndex, $rhs: #ValueReg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestValue($cond: #Condition, $lhs: #BaseIndex, $rhs: #ValueReg, $branch: #MASM^Label)
{
  var $rhsReg'v0: #Reg;
...
function {:constructor} #MASM^Op~BranchTestNullProto($reg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestNullProto($reg: #Reg, $branch: #MASM^Label)
{
  var $data'v0: #RegData;
  var $proto'v1: #TaggedProto;
  var out'0: #RegData;
...
function {:constructor} #MASM^Op~BranchTestLazyProto($reg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestLazyProto($reg: #Reg, $branch: #MASM^Label)
{
  var $data'v0: #RegData;
  var $proto'v1: #TaggedProto;
  var out'0: #RegData;
...
function {:constructor} #MASM^Op~BranchTestUndefined($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestUndefined($condition: #Condition, $valueReg: #ValueReg, $branch: #MASM^Label)
{
  var $value'v0: #Value;
...
function {:constructor} #MASM^Op~BranchTestObjIsFunction($condition: #Condition, $objectReg: #Reg, $scratchReg: #Reg, $spectreRegToZero: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestObjIsFunction($condition: #Condition, $objectReg: #Reg, $scratchReg: #Reg, $spectreRegToZero: #Reg, $branch: #MASM^Label)
{
  var $object'v0: #Object;
  var $shape'v1: #Shape;
  var $class'v2: #Class;
...
function {:constructor} #MASM^Op~BranchTestObjIsFunctionNoSpectreMitigations($condition: #Condition, $objectReg: #Reg, $scratchReg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestObjIsFunctionNoSpectreMitigations($condition: #Condition, $objectReg: #Reg, $scratchReg: #Reg, $branch: #MASM^Label)
{
  var $object'v0: #Object;
  var $shape'v1: #Shape;
  var $class'v2: #Class;
...
function {:constructor} #MASM^Op~BranchTestObjectClass($condition: #Condition, $objectReg: #Reg, $class: #Class, $scratchReg: #Reg, $spectreRegToZero: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestObjectClass($condition: #Condition, $objectReg: #Reg, $class: #Class, $scratchReg: #Reg, $spectreRegToZero: #Reg, $branch: #MASM^Label)
{
  var $object'v0: #Object;
  var $shape'v1: #Shape;
...
function {:constructor} #MASM^Op~BranchTestObjectClassNoSpectreMitigations($condition: #Condition, $objectReg: #Reg, $class: #Class, $scratchReg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestObjectClassNoSpectreMitigations($condition: #Condition, $objectReg: #Reg, $class: #Class, $scratchReg: #Reg, $branch: #MASM^Label)
{
  var $object'v0: #Object;
  var $shape'v1: #Shape;
  var $objectHasClass'v2: #Bool;
...
function {:constructor} #MASM^Op~BranchIfNonNativeObj($objectReg: #Reg, $scratchReg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchIfNonNativeObj($objectReg: #Reg, $scratchReg: #Reg, $branch: #MASM^Label)
{
  var $object'v0: #Object;
  var $shape'v1: #Shape;
  var $class'v2: #Class;
...
function {:constructor} #MASM^Op~BranchTestObjectIsProxy($proxy: #Bool, $objectReg: #Reg, $scratchReg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTestObjectIsProxy($proxy: #Bool, $objectReg: #Reg, $scratchReg: #Reg, $branch: #MASM^Label)
{
  var $object'v0: #Object;
  var $shape'v1: #Shape;
  var $class'v2: #Class;
...
function {:constructor} #MASM^Op~Branch32Imm($condition: #Condition, $lhsReg: #Reg, $rhsInt32: #Int32, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~Branch32Imm($condition: #Condition, $lhsReg: #Reg, $rhsInt32: #Int32, $branch: #MASM^Label)
{
  var $lhsInt32'v0: #Int32;
  var $tmp'v1: #Bool;
  var $tmp'v2: #Bool;
...
function {:constructor} #MASM^Op~Branch32AddressImm32($condition: #Condition, $address: #Address, $rhsInt32: #Int32, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~Branch32AddressImm32($condition: #Condition, $address: #Address, $rhsInt32: #Int32, $branch: #MASM^Label)
{
  var $baseData'v0: #RegData;
  var $data'v1: #RegData;
...
function {:constructor} #MASM^Op~BranchTest32($condition: #Condition, $lhsReg: #Reg, $rhsReg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTest32($condition: #Condition, $lhsReg: #Reg, $rhsReg: #Reg, $branch: #MASM^Label)
{
  var $lhsInt32'v0: #Int32;
  var $rhsInt32'v1: #Int32;
  var $result'v2: #Int32;
...
function {:constructor} #MASM^Op~BranchTest32Imm($condition: #Condition, $lhsReg: #Reg, $rhsInt32: #Int32, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchTest32Imm($condition: #Condition, $lhsReg: #Reg, $rhsInt32: #Int32, $branch: #MASM^Label)
{
  var $lhsInt32'v0: #Int32;
  var $result'v1: #Int32;
  var $tmp'v2: #Bool;
...
function {:constructor} #MASM^Op~BranchAdd32($condition: #Condition, $srcReg: #Reg, $dstReg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchAdd32($condition: #Condition, $srcReg: #Reg, $dstReg: #Reg, $branch: #MASM^Label)
{
  var $lhsInt32'v0: #Int32;
  var $rhsInt32'v1: #Int32;
  var $result'v2: #Int32;
...
function {:constructor} #MASM^Op~BranchAdd32Imm($condition: #Condition, $lhsInt32: #Int32, $dstReg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchAdd32Imm($condition: #Condition, $lhsInt32: #Int32, $dstReg: #Reg, $branch: #MASM^Label)
{
...
function {:constructor} #MASM^Op~BranchSub32($condition: #Condition, $srcReg: #Reg, $dstReg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchSub32($condition: #Condition, $srcReg: #Reg, $dstReg: #Reg, $branch: #MASM^Label)
{
  var $lhsInt32'v0: #Int32;
  var $rhsInt32'v1: #Int32;
  var $result'v2: #Int32;
...
function {:constructor} #MASM^Op~BranchSub32Imm($condition: #Condition, $rhsInt32: #Int32, $dstReg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchSub32Imm($condition: #Condition, $rhsInt32: #Int32, $dstReg: #Reg, $branch: #MASM^Label)
{
  var $lhsInt32'v0: #Int32;
  var $result'v1: #Int32;
...
function {:constructor} #MASM^Op~BranchMul32($condition: #Condition, $srcReg: #Reg, $dstReg: #Reg, $branch: #MASM^Label): #MASM^Op;

procedure #MASM~BranchMul32($condition: #Condition, $srcReg: #Reg, $dstReg: #Reg, $branch: #MASM^Label)
{
  var $lhsInt32'v0: #Int32;
  var $rhsInt32'v1: #Int32;
  var $result'v2: #Int32;
...
procedure #CacheIR~LoadInstanceOfObjectResult($lhsId: #ValueId, $protoId: #ObjectId, emitPath: EmitPath)
{
  ...
  var $scratchReg'v2: #Reg;
  var $failure'l0: #MASM^Label;
  var $returnFalse'l1: #MASM^Label;
  var $returnTrue'l2: #MASM^Label;
  var $done'l3: #MASM^Label;
  var $loopHead'l4: #MASM^Label;
  var out'0: #ValueReg;
  var out'1: #Reg;
  var out'2: #Reg;
  ...
  call $failure'l0 := #MASM^label();
  call #CacheIR~addFailurePath($failure'l0);
  call $returnFalse'l1 := #MASM^label();
  call $returnTrue'l2 := #MASM^label();
  call $done'l3 := #MASM^label();
...
procedure #CacheIR~LoadInt32TruthyResult($inputId: #ValueId, emitPath: EmitPath)
{
  ...
  var $tmp'v1: #Value;
  var $tmp'v2: #Value;
  var $ifFalse'l0: #MASM^Label;
  var $done'l1: #MASM^Label;
  var out'0: #ValueReg;
  var out'1: #Value;
  var out'2: #Value;
  ...
  $valueReg'v0 := out'0;
  call $ifFalse'l0 := #MASM^label();
  call $done'l1 := #MASM^label();
...
procedure #CacheIR~Int32MulResult($lhsId: #Int32Id, $rhsId: #Int32Id, emitPath: EmitPath)
{
  ...
  var $failure'l0: #MASM^Label;
  var $maybeNegZero'l1: #MASM^Label;
  var $done'l2: #MASM^Label;
  var out'0: #Reg;
  var out'1: #Reg;
  var out'2: #Reg;
  var out'3: #Reg;
  ...
  call $failure'l0 := #MASM^label();
  call #CacheIR~addFailurePath($failure'l0);
  call $maybeNegZero'l1 := #MASM^label();
  call $done'l2 := #MASM^label();
  call #MASM^emit(#MASM^Op~Mov($lhsReg'v0, $scratchReg'v2), ConsEmitPath(emitPath, 2));
...
procedure #CacheIR~Int32DivResult($lhsId: #Int32Id, $rhsId: #Int32Id, emitPath: EmitPath)
{
  ...
  var $scratchReg'v3: #Reg;
  var $failure'l0: #MASM^Label;
  var $notOverflow'l1: #MASM^Label;
  var $notZero'l2: #MASM^Label;
  var out'0: #Reg;
  var out'1: #Reg;
  var out'2: #Reg;
  var out'3: #Reg;
  ...
  call $notOverflow'l1 := #MASM^label();
...
procedure {:entrypoint} EntryPoint#CacheStub~GetProp()
{
  ...
  assume {:partition} (#MASM^pcEmitPaths(#MASM^pc) == ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 0), 0), 0));
  op := #MASM^ops(#MASM^pc);
  ...
  assume {:partition} (#MASM^pcEmitPaths(#MASM^pc) == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 1), 0), 0), 0));
  op := #MASM^ops(#MASM^pc);
  ...
  assume {:partition} (#MASM^pcEmitPaths(#MASM^pc) == ConsEmitPath(ConsEmitPath(ConsEmitPath(ConsEmitPath(NilEmitPath(), 2), 0), 0), 0));
  op := #MASM^ops(#MASM^pc);
  call #MASM~UnboxNonDouble($valueReg##MASM^Op~UnboxNonDouble(op), $dstReg##MASM^Op~UnboxNonDouble(op), $valTy##MASM^Op~UnboxNonDouble(op));
  ...
  assume {:partition} (#MASM^pcEmitPaths(#MASM^pc) == ConsEmitPath(ConsEmitPath(NilEmitPath(), 2), 1));
  op := #MASM^ops(#MASM^pc);
