...
lazy_static! {
    ...
    static ref BLOCKED_PATHS: HashMap<Path, CallableRepr> = {
        ...
        HashMap::from([
            ...
            (Ident::from("MASM").nest("stackPushLiveGeneralRegs".into()), Proc),
            (Ident::from("MASM").nest("stackPopLiveGeneralRegs".into()), Proc),
            (Ident::from("MASM").nest("stackPushLiveFloatRegs".into()), Proc),
            (Ident::from("MASM").nest("stackPopLiveFloatRegs".into()), Proc),
