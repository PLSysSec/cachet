...
lazy_static! {
    ...
    static ref BLOCKED_PATHS: HashMap<Path, CallableRepr> = {
        ...
        HashMap::from([
            ...
            (Ident::from("ValueReg").nest("payloadOrValueReg".into()), Proc),
            (Ident::from("LiveGeneralRegSet").nest("add".into()), Proc),
            (Ident::from("LiveGeneralRegSet").nest("take".into()), Proc),
            (Ident::from("LiveGeneralRegSet").nest("contains".into()), Fn),
            (Ident::from("LiveGeneralRegSet").nest("newEmpty".into()), Proc),
            (Ident::from("LiveGeneralRegSet").nest("newVolatile".into()), Proc),
            (Ident::from("LiveFloatRegSet").nest("add".into()), Proc),
            (Ident::from("LiveFloatRegSet").nest("take".into()), Proc),
            (Ident::from("LiveFloatRegSet").nest("contains".into()), Fn),
            (Ident::from("LiveFloatRegSet").nest("newEmpty".into()), Proc),
            (Ident::from("LiveFloatRegSet").nest("newVolatile".into()), Proc),
            ...
            (Ident::from("MASM").nest("getStackIndex".into()), Proc),
            (Ident::from("MASM").nest("setStackIndex".into()), Proc),
