...
lazy_static! {
    ...
    static ref BLOCKED_PATHS: HashMap<Path, CallableRepr> = {
        ...
        HashMap::from([
            ...
            (Ident::from("LiveRegisterSet").nest("addReg".into()), Proc),
            (Ident::from("LiveRegisterSet").nest("takeReg".into()), Proc),
            (Ident::from("LiveRegisterSet").nest("containsReg".into()), Fn),
            (Ident::from("LiveRegisterSet").nest("containsFloatReg".into()), Fn),
            (Ident::from("LiveRegisterSet").nest("newEmpty".into()), Proc),
            (Ident::from("LiveRegisterSet").nest("newVolatile".into()), Proc),
