...
use cachet_lang::ast::{
    ArithBinOper, BinOper, CheckKind, CompareBinOper, ForInOrder, NegateKind, Path, Spanned,
    VarParamKind,
};
...
lazy_static! {
    ...
    static ref BLOCKED_PATHS: HashMap<Path, CallableRepr> = {
        use CallableRepr::*;
        HashMap::from([
            (Path::from_ident_string("StackIndex"), Proc),
            (Path::from_ident_string("StackIndex").nest_string("fromUInt64"), Fn),
            (Path::from_ident_string("StackIndex").nest_string("toUInt64"), Fn),
            (Path::from_ident_string("ValueReg"), Proc),
            (Path::from_ident_string("ValueReg").nest_string("scratchReg"), Proc),
            (Path::from_ident_string("GeneralRegSet").nest_string("empty"), Proc),
            (Path::from_ident_string("GeneralRegSet").nest_string("volatile"), Proc),
            (Path::from_ident_string("GeneralRegSet").nest_string("intersect"), Proc),
            (Path::from_ident_string("GeneralRegSet").nest_string("difference"), Proc),
            (Path::from_ident_string("GeneralRegSet").nest_string("contains"), Fn),
            (Path::from_ident_string("GeneralRegSet").nest_string("add"), Proc),
            (Path::from_ident_string("GeneralRegSet").nest_string("take"), Proc),
            (Path::from_ident_string("FloatRegSet").nest_string("empty"), Proc),
            (Path::from_ident_string("FloatRegSet").nest_string("volatile"), Proc),
            (Path::from_ident_string("FloatRegSet").nest_string("intersect"), Proc),
            (Path::from_ident_string("FloatRegSet").nest_string("difference"), Proc),
            (Path::from_ident_string("FloatRegSet").nest_string("contains"), Fn),
            (Path::from_ident_string("FloatRegSet").nest_string("add"), Proc),
            (Path::from_ident_string("FloatRegSet").nest_string("take"), Proc),
            (Path::from_ident_string("ABIFunction").nest_string("clobberVolatileRegs"), Proc),
            (Path::from_ident_string("MASM").nest_string("getValue"), Proc),
            (Path::from_ident_string("MASM").nest_string("setValue"), Proc),
            (Path::from_ident_string("MASM").nest_string("getData"), Proc),
            (Path::from_ident_string("MASM").nest_string("setData"), Proc),
            (Path::from_ident_string("MASM").nest_string("getFloatData"), Proc),
            (Path::from_ident_string("MASM").nest_string("setFloatData"), Proc),
            (Path::from_ident_string("MASM").nest_string("stackPush"), Proc),
            (Path::from_ident_string("MASM").nest_string("stackPop"), Proc),
            (Path::from_ident_string("MASM").nest_string("stackStore"), Proc),
            (Path::from_ident_string("MASM").nest_string("stackLoad"), Proc),
            (Path::from_ident_string("MASM").nest_string("stackPushLiveGeneralReg"), Proc),
            (Path::from_ident_string("MASM").nest_string("stackPopLiveGeneralReg"), Proc),
            (Path::from_ident_string("MASM").nest_string("stackPushLiveFloatReg"), Proc),
            (Path::from_ident_string("MASM").nest_string("stackPopLiveFloatReg"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("hasAvailableReg"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("isAllocatedValueReg"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("isAllocatedReg"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("allocateValueReg"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("releaseValueReg"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("allocateReg"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("allocateKnownReg"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("releaseReg"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("allocateAvailableFloatRegUnchecked"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("releaseFloatReg"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("defineTypedId"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("defineValueId"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("getOperandLocation"), Proc),
            (Path::from_ident_string("CacheIR").nest_string("setOperandLocation"), Proc),
            (Path::from_ident_string("initRegState"), Proc),
            (Path::from_ident_string("initOperandId"), Proc),
            (Path::from_ident_string("initInputValueId"), Proc),
            (Path::from_ident_string("addLiveFloatReg"), Proc),
        ])
    };
}
