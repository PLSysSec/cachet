...
lazy_static! {
    ...
    static ref BLOCKED_PATHS: HashMap<Path, CallableRepr> = {
        ...
        HashMap::from([
            ...
            (Ident::from("CacheIR").nest("allocateKnownValueReg".into()), Proc),
            ...
            (Ident::from("CacheIR").nest("getRegOperand".into()), Proc),
            (Ident::from("CacheIR").nest("setRegOperand".into()), Proc),
            (Ident::from("CacheIR").nest("setValueRegOperand".into()), Proc),
