...
lazy_static! {
    ...
    static ref BLOCKED_PATHS: HashMap<Path, CallableRepr> = {
        ...
        HashMap::from([
            ...
            (Ident::from("MASM").nest("getSymbol".into()), Proc),
            (Ident::from("MASM").nest("setSymbol".into()), Proc),
            (Ident::from("MASM").nest("getBigInt".into()), Proc),
            (Ident::from("MASM").nest("setBigInt".into()), Proc),
            ...
            (Ident::from("CacheIR").nest("defineObjectReg".into()), Proc),
            (Ident::from("CacheIR").nest("defineInt32Reg".into()), Proc),
            (Ident::from("CacheIR").nest("defineNumberReg".into()), Proc),
            (Ident::from("CacheIR").nest("defineBooleanReg".into()), Proc),
            (Ident::from("CacheIR").nest("defineStringReg".into()), Proc),
            (Ident::from("CacheIR").nest("defineSymbolReg".into()), Proc),
            (Ident::from("CacheIR").nest("defineBigIntReg".into()), Proc),
            (Ident::from("CacheIR").nest("useValueReg".into()), Proc),
            (Ident::from("CacheIR").nest("useObjectReg".into()), Proc),
            (Ident::from("CacheIR").nest("useInt32Reg".into()), Proc),
            (Ident::from("CacheIR").nest("useNumberReg".into()), Proc),
            (Ident::from("CacheIR").nest("useBooleanReg".into()), Proc),
            (Ident::from("CacheIR").nest("useStringReg".into()), Proc),
            (Ident::from("CacheIR").nest("useSymbolReg".into()), Proc),
            (Ident::from("CacheIR").nest("useBigIntReg".into()), Proc),
            (Ident::from("CacheIR").nest("initValueInput".into()), Proc),
            (Ident::from("CacheIR").nest("initObjectInput".into()), Proc),
            (Ident::from("CacheIR").nest("initInt32Input".into()), Proc),
            (Ident::from("CacheIR").nest("initNumberInput".into()), Proc),
            (Ident::from("CacheIR").nest("initBooleanInput".into()), Proc),
            (Ident::from("CacheIR").nest("initStringInput".into()), Proc),
            (Ident::from("CacheIR").nest("initSymbolInput".into()), Proc),
            (Ident::from("CacheIR").nest("initBigIntInput".into()), Proc),
        ])
    };
