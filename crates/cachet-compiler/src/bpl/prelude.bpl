...
// Documentation on Boogie's built-in functions can be found at:
...
type {:datatype} CallPath;
function {:constructor} NilCallPath(): CallPath;
function {:constructor} ConsCallPath(init: CallPath, last: int): CallPath;
...
type $Double = float53e11;
// 64-bit; see https://github.com/boogie-org/boogie/issues/29#issuecomment-231239065
...
// TODO(spinda): Implement $Double^neq.
...
// See the heading "Conversion from other sorts" at:
